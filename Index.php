...
<div class="icons">
   ...
   <a href="logic.php"><i class="fa fa-user" id="login-btn"></i></a>
</div>
    ...
    <div class="swiper trusted-by-professional-slider">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide box-2">
                ...
                <p>Cutting down delivery time and driving up visibility at the same time?! Now that's game changing!</p>
                <h1>Sam Stanton</h1>
...
<section class ="apart" id="apart">
    ...
    <div class="box-container-y">
        <div class="a-box">
            ...
            <p class="sp">Founded by <span>Anand Rath</span> Made with industry leaders in the field of computer vision and machinelearning</p>
    ...
    <div class="box-container-z">
        <div class="a-box">
            ...
            <p>This platform allows you to monetize every single image, generate leads your customers with cutting edge tech.</p>
